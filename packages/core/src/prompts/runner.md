...
When the conversation is complete (you've covered the reference's intent), output exactly:
<<<DONE>>>

That token must appear alone on its own line. Do not include it mid-conversation.
